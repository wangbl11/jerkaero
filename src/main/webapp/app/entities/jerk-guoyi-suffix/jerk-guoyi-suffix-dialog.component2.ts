...
export class JerkGuoyiSuffixDialogComponent implements OnInit {
    ...
    ngOnInit() {
        ...
        this.registrationService
            ...
            .subscribe((res: HttpResponse<RegistrationGuoyiSuffix[]>) => {
                if (!this.jerk.jerkInfo || !this.jerk.jerkInfo.id) {
                    this.jerkinfos = res.body;
                } else {
                    this.registrationService
                        .find(this.jerk.jerkInfo.id)
                        .subscribe((subRes: HttpResponse<RegistrationGuoyiSuffix>) => {
                            this.jerkinfos = [subRes.body].concat(res.body);
