package com.guoyi.jerkaero.service.util;
            ...
            for (int j = 0; j < field.length; j++) { // 遍历所有属性
                ...
                if (type.equals("class java.lang.Long")) {
	                ...
	                if (value == null) {
	                    ...
	                    m.invoke(t, (Long)entityMap.get(yname));
	                }
                }
