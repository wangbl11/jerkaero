package com.guoyi.jerkaero.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            cm.createCache(com.guoyi.jerkaero.repository.UserRepository.USERS_BY_LOGIN_CACHE, jcacheConfiguration);
            cm.createCache(com.guoyi.jerkaero.repository.UserRepository.USERS_BY_EMAIL_CACHE, jcacheConfiguration);
            cm.createCache(com.guoyi.jerkaero.domain.User.class.getName(), jcacheConfiguration);
            cm.createCache(com.guoyi.jerkaero.domain.Authority.class.getName(), jcacheConfiguration);
            cm.createCache(com.guoyi.jerkaero.domain.User.class.getName() + ".authorities", jcacheConfiguration);
