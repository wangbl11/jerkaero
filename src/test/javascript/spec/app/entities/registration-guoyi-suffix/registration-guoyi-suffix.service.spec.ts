...
describe('Service Tests', () => {
    ...
    describe('RegistrationGuoyiSuffix Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(RegistrationGuoyiSuffixService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/registrations';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return RegistrationGuoyiSuffix', () => {
