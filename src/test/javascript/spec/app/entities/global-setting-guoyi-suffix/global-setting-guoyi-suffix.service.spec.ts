...
describe('Service Tests', () => {
    ...
    describe('GlobalSettingGuoyiSuffix Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(GlobalSettingGuoyiSuffixService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/global-settings';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return GlobalSettingGuoyiSuffix', () => {
