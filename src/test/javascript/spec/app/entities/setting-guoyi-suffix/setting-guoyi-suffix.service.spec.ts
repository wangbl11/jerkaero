...
describe('Service Tests', () => {
    ...
    describe('SettingGuoyiSuffix Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(SettingGuoyiSuffixService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/settings';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return SettingGuoyiSuffix', () => {
